		...
		Ai1wm_Status::done(
			...
			sprintf(
				__(
					...
					'<strong>1. Kalıcı bağlantı ayarlarını 2 kere kayıt etmelisiniz. <a class="ai1wm-no-underline" href="%s" target="_blank">Kalıcı Bağlantı Ayarları</a></strong> <small>(yeni pencerede açar)</small><br />' .
					'<strong>2. <a class="ai1wm-no-underline" href="https://www.youtube.com/channel/UCg7ce54UQpDAzPNDm0igiiA" target="_blank">Kanalıma Abone Olmayı Unutmayınız</a>.</strong> <small>(yeni pencerede açar)</small>',
					AI1WM_PLUGIN_NAME
				),
